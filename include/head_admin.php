...
include '../../database/config.php'; // include the database conncetion
    ...
    $query = "SELECT * FROM admin_tb WHERE Admin_id='{$_COOKIE['admin']}'";
          ...
          <img src="../../img/Logo.jpg" alt="Logo" width="130" height="75"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <ul class="navbar-nav mr-auto" >
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="CRUD_Agent/display_Agent.php">Manage Agents</a>
                </li>
              </ul>
            </div>
            ...
            <div class="ml-auto">
                  <ul style="list-style: none;">
                      <li class="nav-item active dropdown">
                        ...
                        <img src="../../<?php echo $AdminAvatar ?>" class="avatarImage" >Account</a>
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="../Admin_Account.php">Account</a> <!-- Logs admin out --> 
