    ...
    https://www.youtube.com/watch?v=OMNM0Trsmyc -->
        ...
        <div class="card_body">
            ...
            <?php
                ...
                if($page>1){
                    echo "<a href='index.php?page=".($page-1)."' class='btn pagenumber-btn' Style='background-color:#333740; color:white;'>Previous</a>";
                }
                
                // Create the numbered navigation buttons. That navigates between page using index values to go to a precise page.   
                for($i=1;$i<$total_page;$i++){
                    echo "<a href='index.php?page=".($i)."' class='btn pagenumber-btn' Style='background-color:#EEC494; color:black;'>$i</a>";
                }
                // $i is the total number of page
                // If there are more page to go to, then you can click next.
                if($i>$page){
                    echo "<a href='index.php?page=".($page+1)."' class='btn pagenumber-btn' Style='background-color:#333740; color:white;'>Next</a>";
                }
